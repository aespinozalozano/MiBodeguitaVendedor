...
public class Count extends Drawable {private Paint paint1, paint2, paint3;
    ...
    private Count(Context context) {
        ...
        paint1 = new Paint();
        paint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.background_color));
        paint1.setAntiAlias(true);
        paint1.setStyle(Paint.Style.FILL);
        paint2 = new Paint();
        paint2.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.background_color));
